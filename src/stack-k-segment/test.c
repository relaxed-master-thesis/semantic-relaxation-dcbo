...
//ad create thread stack array pointer
double *node_tag;
...
int main(int argc, char **argv)
{
  ...
  while(1)
    {
		i = 0;
		c = getopt_long(argc, argv, "hAf:d:i:n:r:u:m:a:l:p:b:v:f:k:m:w:", long_options, &i);
		if(c == -1)
			break;
